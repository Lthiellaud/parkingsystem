...
/**
 * SQL Requests used in the application.
 */
public class DBConstants {
    ...
    public static final String SAVE_TICKET = "insert into "
       + " ticket(PARKING_NUMBER, VEHICLE_REG_NUMBER, PRICE, IN_TIME, OUT_TIME, DISCOUNT)"
       + " values(?,?,?,?,?,?)";
    public static final String UPDATE_TICKET =
            "update ticket set PRICE=?, OUT_TIME=? where ID=?";
    public static final String CHECK_RECURRING_USER =
