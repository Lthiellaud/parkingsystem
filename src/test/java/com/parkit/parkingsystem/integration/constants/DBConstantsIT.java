...
public class DBConstantsIT {
    ...
    public static final String SAVE_TICKET_IT = "insert " +
            "into ticket(PARKING_NUMBER, VEHICLE_REG_NUMBER, PRICE, IN_TIME, OUT_TIME) values(1,?,0,?,?)";
    //Idem GET_TICKET used for ticketDAO.getTicket() except for the "where" condition.
    //The exit is done => outTime is not null
    public static final String GET_EXITED_VEHICLE_TICKET_IT = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, p.TYPE "
